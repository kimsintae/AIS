...
/***/
            (function (module, exports, __webpack_require__) {
                ...
                var ChartInternal = function () {
                    ...
                    return ChartInternal.prototype.beforeInit = function beforeInit() {
                        ...
                        if ($$.initParams(), config.data_url) $$.convertUrlToData(config.data_url, config.data_mimeType, config.data_headers, config.data_keys, $$.initWithData);
		...
		["Pie", "Bar", "Line", "Arc", "Gauge", "Bubble", "Text"].forEach(function (v) {
                        ...
                        if ($$.inputType === "touch" && $$.hideTooltip(), withLegend && config.legend_show && !config.legend_contents_bindto ? $$.updateLegend($$.mapToIds($$.data.targets), options, transitions) : withDimension && $$.updateDimension(!0), $$.isCategorized() && targetsToShow.length === 0 && $$.x.domain([0, $$.axes.x.selectAll(".tick").size()]), targetsToShow.length ? ($$.updateXDomain(targetsToShow, withUpdateXDomain, withUpdateOrgXDomain, withTrimXDomain), !config.axis_x_tick_values && (tickValues = $$.axis.updateXAxisTickValues(targetsToShow))) : ($$.xAxis.tickValues([]), $$.subXAxis.tickValues([])), config.zoom_rescale && !options.flow && (xDomainForZoom = $$.x.orgDomain()), $$.y.domain($$.getYDomain(targetsToShow, "y", xDomainForZoom)), $$.y2.domain($$.getYDomain(targetsToShow, "y2", xDomainForZoom)), !config.axis_y_tick_values && config.axis_y_tick_count && $$.yAxis.tickValues($$.axis.generateTickValues($$.y.domain(), config.axis_y_tick_count, $$.isTimeSeriesY())), !config.axis_y2_tick_values && config.axis_y2_tick_count && $$.y2Axis.tickValues($$.axis.generateTickValues($$.y2.domain(), config.axis_y2_tick_count)), $$.axis.redraw(transitions, hideAxis), $$.axis.updateLabels(withTransition), (withUpdateXDomain || withUpdateXAxis) && targetsToShow.length)
                            if (config.axis_x_tick_culling && tickValues) {
                                for (var _i = 1; _i < tickValues.length; _i++)
                                    if (tickValues.length / _i < config.axis_x_tick_culling_max) {
...
/***/
            (function (module, exports, __webpack_require__) {
                ...
                var Chart = function Chart(config) {
                    ...
                    this.internal = $$, $$.loadConfig(config), $$.beforeInit(config), $$.init(), $$.afterInit(config),
            ...
            (function (module, exports, __webpack_require__) {
                ...
                exports.default = function () {
                    ...
                    return axis.scale = function (x) {
                        ...
                        if (params.isCategory) interval = tickOffset * 2;
                        else {
                ...
                (0, _util.extend)(_ChartInternal2.default.prototype, {
                    ...
                    findValueInJson: function findValueInJson(object, path) {
                        ...
                        for (var _iterator3 = pathArray, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
                            ...
                            if (k in target) target = target[k];
                            else {
                                target = undefined;
                    ...
                    convertColumnsToData: function convertColumnsToData(columns) {
                        ...
                        for (i = 0; i < columns.length; i++)
                            for (key = columns[i][0], j = 1; j < columns[i].length; j++) {
                        ...
                        var targets = ids.map(function (id, index) {
                            ...
                            return {
                                ...
                                values: data.map(function (d, i) {
                                    ...
                                    return $$.isCustomX() && $$.isCategorized() && index === 0 && !(0, _util.isUndefined)(rawX) ? (index === 0 && i === 0 && (config.axis_x_categories = []), x = config.axis_x_categories.indexOf(rawX), x === -1 && (x = config.axis_x_categories.length, config.axis_x_categories.push(rawX))) : x = $$.generateTargetX(rawX, id, i), ((0, _util.isUndefined)(d[id]) || $$.data.xs[id].length <= i) && (x = undefined), {
                                        x: x,
                                        value: value,
                                        id: convertedId
                                    };
            ...
            (function (module, exports, __webpack_require__) {
                ...
                (0, _util.extend)(_ChartInternal2.default.prototype, {
                    ...
                    updateEventRect: function updateEventRect(eventRectUpdate) {
                        ...
                        if ($$.isMultipleX()) x = 0, y = 0, w = $$.width, h = $$.height;
                        else {
                            var rectW = void 0,
                                rectX = void 0;
                    ...
                    lineWithRegions: function lineWithRegions(d, x, y, _regions) {
                        ...
                        function isWithinRegions(withinX, withinRegions) {
                            ...
                            for (idx = 0; idx < withinRegions.length; idx++)
                                if (withinRegions[idx].start < withinX && withinX <= withinRegions[idx].end) return !0;
                            return !1;
                        }
                        ...
                        if ((0, _util.isDefined)(_regions))
                            for (i = 0; i < _regions.length; i++) regions[i] = {}, regions[i].start = (0, _util.isUndefined)(_regions[i].start) ? d[0].x : $$.isTimeSeries() ? $$.parseDate(_regions[i].start) : _regions[i].start, regions[i].end = (0, _util.isUndefined)(_regions[i].end) ? d[d.length - 1].x : $$.isTimeSeries() ? $$.parseDate(_regions[i].end) : _regions[i].end;
                        ...
                        // Draw as normal
                            if ((0, _util.isUndefined)(regions) || !isWithinRegions(d[i].x, regions)) s += " " + xValue(d[i]) + " " + yValue(d[i]);
                            else
                                for (xp = $$.getScale(d[i - 1].x + xOffset, d[i].x + xOffset, $$.isTimeSeries()), yp = $$.getScale(d[i - 1].value, d[i].value), dx = x(d[i].x) - x(d[i - 1].x), dy = y(d[i].value) - y(d[i - 1].value), dd = Math.sqrt(Math.pow(dx, 2) + Math.pow(dy, 2)), diff = 2 / dd, diffx2 = diff * 2, j = diff; j <= 1; j += diffx2) s += sWithRegion(d[i - 1], d[i], j, diff);
                    ...
                    generatePoint: function generatePoint() {
                        ...
                        return function (method, context) {
                            ...
                            return function (d) {
                                ...
                                if (ids.indexOf(id) < 0 && ids.push(id), point = pattern[ids.indexOf(id) % pattern.length], $$.hasValidPointType(point)) point = $$[point];
            ...
            (function (module, exports, __webpack_require__) {
                ...
                (0, _util.extend)(_ChartInternal2.default.prototype, {
                    ...
                    getYForText: function getYForText(points, d, textElement) {
                        ...
                        if (config.axis_rotated) yPos = (points[0][0] + points[2][0] + textElement.getBoundingClientRect().height * 0.6) / 2;
                        else if (yPos = points[2][1], d.value < 0 || d.value === 0 && !$$.hasPositiveValue) yPos += textElement.getBoundingClientRect().height, $$.isBarType(d) && $$.isSafari() ? yPos -= 3 : !$$.isBarType(d) && $$.isChrome() && (yPos += 3);
                        else {
                            var diff = -6;
            ...
            (function (module, exports, __webpack_require__) {
                ...
                (0, _util.extend)(_ChartInternal2.default.prototype, {
                    ...
                    getTooltipContent: function getTooltipContent(d, defaultTitleFormat, defaultValueFormat, color) {
                        ...
                        for (var row, i = 0, len = d.length; i < len; i++)
                            if ((row = d[i]) && (row.value || row.value === 0) && (text || (title = (0, _util.sanitise)(titleFormat ? titleFormat(row.x) : row.x), text = title || title === 0 ? "<tr><th colspan=\"2\">" + title + "</th></tr>" : "", text = "<table class=\"" + $$.CLASS.tooltip + "\">" + text), value = (0, _util.sanitise)(valueFormat(row.value, row.ratio, row.id, row.index, d)), value !== undefined)) {
                    ...
                    drag: function drag(mouse) {
                        ...
                        if (!$$.hasArcType() && config.data_selection_enabled && (!config.zoom_enabled || $$.zoom.altDomain) && config.data_selection_multiple) // skip if zoomable because of conflict drag dehavior
                        {
                            ...
                            main.select("." + _classes2.default.dragarea).attr("x", minX).attr("y", minY).attr("width", maxX - minX).attr("height", maxY - minY), main.selectAll("." + _classes2.default.shapes).selectAll("." + _classes2.default.shape).filter(function (d) {
                                ...
                                if (shape.classed(_classes2.default.circle)) _x = shape.attr("cx") * 1, _y = shape.attr("cy") * 1, toggle = $$.togglePoint, isWithin = minX < _x && _x < maxX && minY < _y && _y < maxY;
                                else if (shape.classed(_classes2.default.bar)) box = (0, _util.getPathBox)(this), _x = box.x, _y = box.y, _w = box.width, _h = box.height, toggle = $$.togglePath, isWithin = !(maxX < _x || _x + _w < minX) && !(maxY < _y || _y + _h < minY);
                                else
                    ...
                    generateLevelColor: function generateLevelColor() {
                        ...
                        return (0, _util.notEmpty)(threshold) ? function (value) {
                            ...
                            for (var v, i = 0; i < values.length; i++)
                                if (v = asValue ? value : value * 100 / max, v < values[i]) {
                                    color = colors[i];
            ...
            (function (module, exports, __webpack_require__) {
                ...
                (0, _util.extend)(_ChartInternal2.default.prototype, {
                    getYFormat: function getYFormat(forArc) {
                        ...
                        return forArc && !$$.hasType("gauge") && (formatForY = $$.defaultArcValueFormat, formatForY2 = $$.defaultArcValueFormat),
                            function (v, ratio, id) {
                ...
                (0, _util.extend)(_ChartInternal2.default.prototype, {
                    hasCaches: function hasCaches(ids) {
                        for (var i = 0, len = ids.length; i < len; i++)
                            if (!(ids[i] in this.cache)) return !1;
            ...
            (function (module, exports, __webpack_require__) {
                ...
                (0, _util.extend)(zoom, {
                    ...
                    max: function max(_max) {
                        ...
                        if (_max === 0 || _max) config.zoom_x_max = (0, _d.max)([$$.orgXDomain[1], _max]);
                        else return config.zoom_x_max;
                    ...
                    min: function min(_min) {
                        ...
                        if (_min === 0 || _min) config.zoom_x_min = (0, _d.min)([$$.orgXDomain[0], _min]);
                        else return config.zoom_x_min;
                    ...
                    range: function range(_range) {
                        ...
                        if (arguments.length)(0, _util.isDefined)(_range.max) && domain.max(_range.max), (0, _util.isDefined)(_range.min) && domain.min(_range.min);
                        else return {
                            max: domain.max(),
                            min: domain.min()
                        };
            ...
            (function (module, exports, __webpack_require__) {
                ...
                (0, _util.extend)(_Chart2.default.prototype, {
                    ...
                    flow: function flow(args) {
                        ...
                        if (args.json) data = $$.convertJsonToData(args.json, args.keys);
                ...
                var setMinMax = function ($$, type, value) {
                    ...
                    axis = (0, _util.extend)(function () {}, {
                        ...
                        range: function range(_range) {
                            ...
                            if (arguments.length)(0, _util.isDefined)(_range.max) && axis.max(_range.max), (0, _util.isDefined)(_range.min) && axis.min(_range.min);
                            else return {
                                max: axis.max(),
                                min: axis.min()
                            };
